...
class LogFLTransformer:
    def __init__(self, features, labels, feature_names, feature_scale_factor: float, label_scale_factor: float):
        ...
        vel_indices = [feature_names.index(n) for n in ['sivelv', 'sivelu'] if n in feature_names]
